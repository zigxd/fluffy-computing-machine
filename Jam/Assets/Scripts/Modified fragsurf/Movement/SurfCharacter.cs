...
namespace Fragsurf.Movement {
    ...
    public class SurfCharacter : MonoBehaviour, ISurfControllable {
        ...
        private void Awake () {
            ...
            input = new Easyfps();
            input.Player.Sprint.performed += ctx => Sprint(true);
        ...
        {
            _moveData.sprinting = state;
        }
        private void Crouch(bool state)
        {
            _moveData.crouching = state;
        }
        private void Jump(bool state)
        {
            jump = state;
            _moveData.wishJump = state;
        }
        ...
        private void UpdateMoveData () {
            ...
            _moveData.verticalAxis = move.y;
            _moveData.horizontalAxis = move.x;
